...
public class CC {
    ...
    public static final String CLEAN_CHAT = ChatColor.WHITE.toString() + " ";
    public static final String BRIDGIN = ChatColor.DARK_AQUA.toString() + ChatColor.ITALIC.toString() + "[Bridgin 1.0-SNAPSHOT]";
